...
def saveBERTopic_distributions(model, probs):
   ...
   # Initialize dictionary to hold topic-word distributions
    ...
    # Save to CSV
    topic_word_df.to_csv(f"{path}/50_BERTopic_topic_word_distribution.csv", index_label="Topic")
...
def run_bertopic():
    ...
    bertopic_model = BERTopic(calculate_probabilities=True, top_n_words=50)
